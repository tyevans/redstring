...
from redstring.domain.exceptions import UnknownDomainError
from redstring.extraction.domains.registry import get_domain_registry, get_domain_schema
...
def domain_system_prompt(domain: str | DomainSchema) -> str:
    ...
    Raises:
        UnknownDomainError: No such domain. The message lists the ones that
            ...
            here because this is the public boundary and `RedstringError` is
