...
Sibling of `kg_builder.graph` and `kg_builder.vector` in the layered contract,
and held apart from `kg_builder.extraction` by it: extraction depends on
`kg_builder.ports.llm_provider`, never on anything in here. That is what keeps
