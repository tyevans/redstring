...
one. Shaped like this, it touches `kg_builder.llm.adapters` and nothing else.

**No `langchain*` type may appear in `domain/`, `ports/`, or any signature
outside `kg_builder/llm/adapters/`.** That is the whole point of the port,
...
See `kg_builder.llm.adapters.langchain`.
"""
